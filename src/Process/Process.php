...
class Process implements ProcessInterface
{
    ...
    public function init()
    {
        ...
        if ($locker !== null && $locker->isLocked())
        {
            ...
            $dev = isset($lockData['packages-dev']) ? $lockData['packages-dev'] : [];
        ...
        $rootExtras = $rootPackage ? $rootPackage->getExtra() : [];
        $customComponents = isset($rootExtras['component']) ? $rootExtras['component'] : [];
        foreach ($allPackages as $package)
        {
            $name = $package['name'];
            if (isset($customComponents[$name]) && is_array($customComponents[$name]))
            {
                $package['extra'] = ['component' => $customComponents[$name]];
     ...
     */
    public function getComponentName($prettyName, array $extra = [])
    {
        ...
        $component = isset($extra['component']) ? $extra['component'] : [];
